  ...
  <nav class="navbar bg-dark navbar-dark navbar-expand-sm">
    <div class="container">
      <div class="navbar-nav ml-sm-auto">
        ...
        <a class="nav-item nav-link dropdown-toggle" data-toggle="dropdown" id="unosDropdown" aria-haspopup="true" aria-expanded="false" href="#">Unos</a>
        ...
        <a class="nav-item nav-link active" href="index_administracijaKupca.php?cid">Administracija kupca</a>
      </div>
    </div>
  </nav>
  ...
  <div class="container" id="wrapper">
    ...
    <div class="row" >
      <section class="col-12" id="firstRow">
         <?php        
            include('inc/administracijaKupca.php');
          ?>
      </section>
    </div>
